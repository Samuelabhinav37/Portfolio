/* Luna chat drawer knowledge base for the contact page. Extracted from an
   inline <script id="ldw-engine"> block. Includes a page-specific
   extraTargetHandler that scrolls to and focuses a form field. */
